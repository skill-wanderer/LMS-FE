...
3. [Endpoints](#endpoints)
   ...
   - [Get Course Progress](#get-course-progress)
...
- **On page load:** optionally call `GET .../complete` to hydrate the completion state (or use the course progress endpoint for the full sidebar).
