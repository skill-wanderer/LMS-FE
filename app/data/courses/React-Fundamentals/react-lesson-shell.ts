...
interface ReactModuleAssignmentShellOptions {
  id: string
  slug: string
  title: string
  order: number
...
interface ReactModuleSummaryQuizShellOptions {
  id: string
  slug: string
  title: string
  order: number
...
export function createReactModuleAssignmentShell(options: ReactModuleAssignmentShellOptions): Lesson {
  const content = [
...
export function createReactModuleSummaryQuizShell(options: ReactModuleSummaryQuizShellOptions): Lesson {
  const content = [
